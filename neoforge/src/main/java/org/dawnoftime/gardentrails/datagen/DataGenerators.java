...
@Mod.EventBusSubscriber(modid = GTCommon.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new GTLootModifierProvider(packOutput));
    }
}